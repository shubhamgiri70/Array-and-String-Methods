...
function countAllPeople() {
  const totalPeople = got.houses.reduce((acc, house) => {
...
function peopleByHouses() {
  const final = got.houses.reduce((acc, house) => {
...
function everyone() {
  const final = got.houses.reduce((acc, house) => {
    names = house.people.map((person) => person.name);
...
function nameWithS() {
  ...
  peopleWithS = peopleWithS.filter((name) => name.toLowerCase().includes("s"));
...
function nameWithA() {
  ...
  peopleWithA = peopleWithA.filter((name) => name.toLowerCase().includes("a"));
  return peopleWithA;
}
